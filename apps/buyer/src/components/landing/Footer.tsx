        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-4 mt-2">
              <a href="#" className="text-gray-400 hover:text-purple-500 transition-colors" title="Instagram">
                <Instagram className="w-5 h-5" />
              </a>
              <a href="#" className="text-gray-400 hover:text-purple-500 transition-colors" title="Facebook">
                <Facebook className="w-5 h-5" />
              </a>
              <a href="#" className="text-gray-400 hover:text-purple-500 transition-colors" title="LinkedIn">
                <Linkedin className="w-5 h-5" />
              </a>
              {/* WhatsApp Icon (Same as screenshot) */}
              <a href="#" className="text-gray-400 hover:text-purple-500 transition-colors" title="WhatsApp">
