  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="fixed top-0 right-0 bottom-0 w-full sm:w-[420px] bg-white z-[100] shadow-2xl flex flex-col overflow-hidden sm:rounded-l-3xl p-6 md:p-8 font-sans"
      >
        {/* Header */}
