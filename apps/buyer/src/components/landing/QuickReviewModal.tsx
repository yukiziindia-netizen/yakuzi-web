        ...
        {isOpen && (
          ...
          >
            ...
            <motion.div
              ...
              className="glass-overlay no-scrollbar relative flex max-h-[90vh] w-full max-w-[95%] xs:max-w-[500px] sm:max-w-[560px] md:max-w-[590px] flex-col gap-4 sm:gap-5 overflow-y-auto p-4 sm:p-6"
              ...
              >
                ...
                <div className="absolute -left-3.5 -top-3.5 z-30">
                  <ShareButton
                    ...
                    className="rounded-full border border-white/70 bg-white/60 p-3 text-gray-600 backdrop-blur-md transition-transform hover:scale-105 hover:bg-white/80 focus:outline-none"
                ...
                <div className="absolute left-4 bottom-4 z-20 flex flex-col gap-2">
                  {productImages.map((img: string, idx: number) => (
                    <button
                      ...
                      className={`h-14 w-14 overflow-hidden rounded-lg border bg-white/50 shadow-sm backdrop-blur-md transition-all duration-200 ${
