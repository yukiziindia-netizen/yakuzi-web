...
export function OrderedProductsDrawer({ isOpen, onClose, orderId }: OrderedProductsDrawerProps) {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div className={`fixed inset-y-0 right-0 w-[92%] sm:w-[500px] md:w-[520px] max-w-full bg-white shadow-2xl z-[110] transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : 'translate-x-full'} overflow-y-auto rounded-l-3xl`}>
        {/* Hidden Close Button */}
