...
export const renderBuyerOfferBadge = (p: any) => {
  ...
  return <span className="bg-[#864ac5] text-white px-2 py-0.5 rounded text-[10px] sm:text-[11px] font-bold tracking-wide shadow-sm whitespace-nowrap">{p.discountType.replace(/_/g, ' ')}</span>;
};
