...
import { User, Lock, Eye, EyeOff, Loader2, Phone, KeyRound, Undo2 } from 'lucide-react';
...
export default function LoginPage() {
  ...
  const { sendOtp, verifyOtp, registerBuyer, loginWithPassword, isAuthenticated, isLoading: authLoading } = useAuth();
  ...
  if (authLoading) return <main className="h-screen flex items-center justify-center bg-white"><Loader2 className="w-8 h-8 animate-spin text-[#8B5CF6]" /></main>;
      ...
      <div className="z-10 w-full max-w-sm flex flex-col items-center mt-[-10vh]">
        ...
        {isSignupMode ? (
          <div className="w-full flex flex-col items-center">
            {signupStep === 1 ? (
              <>
                <h2 className="text-[#2e2b35] text-[19px] mb-12 tracking-wide">
                ...
                <input
                  ...
                  className="bg-transparent text-[#2e2b35] text-center text-xl font-medium outline-none w-full max-w-[240px] mb-[60px] border-b border-[#e0d5ec] focus:border-[#8e44ad] pb-1"
                  autoFocus
                />
              ...
              <>
                ...
                <div className="w-full flex flex-col items-center mb-[60px] space-y-4">
                  ...
                  <input
                    ...
                    className="bg-transparent text-[#2e2b35] text-center text-xl font-medium outline-none w-full max-w-[240px] border-b border-[#e0d5ec] focus:border-[#8e44ad] pb-1"
                    autoFocus
                  />
                </div>
              ...
              <>
                ...
                <h3 className="text-[#2e2b35] text-[20px] font-medium mb-[60px] tracking-wide">
                  What is your name ?
                </h3>
              ...
              <>
                ...
                <button
                  type="button"
                  onClick={() => {
                    if (!signupPassword) { toast('Please enter a password', 'error'); return; }
              ...
              <>
                ...
                {/* Calendar UI Mock */}
                <div className="bg-white rounded-[16px] p-5 w-[280px] shadow-[0_10px_30px_rgba(142,68,173,0.12)] mb-6 select-none border border-[#ece6f5]">
                ...
                <h3 className="text-[#2e2b35] text-[19px] font-medium mb-4 tracking-wide">
                  Gender
                </h3>
                
                <div className="flex space-x-6 mb-8 text-[#2e2b35] font-medium text-[17px]">
          ...
          <>
            ...
            <div className="w-full flex flex-col items-center">
              <div className="flex items-center justify-center space-x-4 mt-8 mb-6 w-full">
                ...
                <span className="text-[#9b93a8] font-medium text-lg">or</span>
                <div className="h-px w-12 bg-[#e4dcef]"></div>
              </div>
